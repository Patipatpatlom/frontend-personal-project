...
console.log(cart)
  return (
    <div className="navbar bg-white/60 backdrop-blur-md shadow-lg px-4 md:px-6 sticky top-0 z-50 border-b border-pink-100 flex flex-col md:flex-row gap-3 md:gap-0 py-3 md:py-0 h-auto">
